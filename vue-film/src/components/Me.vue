<template>
  <div>
    ...
    <div class="hender">
      ...
      <div style="font-size: 16px" @click="fn">立即登录</div>
    </div>
    <div class="main">
      <span>
        <div class="value">0张</div>
        <div class="lable">卖座券</div>
      </span>
      <span>
    ...
    <div>
      ...
      <div class="end">
        <img
          src="https://assets.maizuo.com/h5/v5/public/app/img/help.a9203368.png"
          alt=""
          style="width: 20px; height: 20px"
        />
